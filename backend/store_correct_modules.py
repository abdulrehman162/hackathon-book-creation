...
def main():
    """
    Store content from specific modules in Qdrant based on sitemap
    """
    print("Starting to store correct module content in Qdrant based on sitemap...")

    # Target specific module URLs found in sitemap
    module_urls = [
        "https://hackathon01-book-creation-lnvq.vercel.app/docs/module2-digital-twin/",  # Digital Twin Simulation
        "https://hackathon01-book-creation-lnvq.vercel.app/docs/module3-urdf/",          # Module 3: URDF (Robot Structure)
        "https://hackathon01-book-creation-lnvq.vercel.app/docs/module4-isaac-ai-brain/", # Module 4: Isaac AI-Robot Brain
        # Adding some specific pages from the sitemap that might contain ROS2 content
        "https://hackathon01-book-creation-lnvq.vercel.app/docs/module1-intro-ros2/",
        "https://hackathon01-book-creation-lnvq.vercel.app/docs/module2-communication/",  # This might have ROS2 communication
    ]
    ...
    # Verify by retrieving sample vectors from each module
    print(f"\nRetrieving sample vectors to verify module content...")

    # Get some sample vectors to show what was added
    points = qdrant_client.scroll(
        collection_name='rag_embedding',
        limit=10  # Get first 10 points to see variety
    )

    print(f"\nSample vectors in collection:")
    for i, point in enumerate(points[0]):
        url = point.payload.get("url", "")
        title = point.payload.get("title", "")
        text_preview = str(point.payload.get("text", ""))[:100] + "..."
