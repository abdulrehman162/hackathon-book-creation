...
async def main():
    ...
    for i, url in enumerate(urls):
        ...
        if processed_count >= 10:  # Process only first 10 URLs to be respectful
            print(f"Processed {processed_count} URLs (limited for demonstration)")
            break

    print(f"Pipeline completed! Processed {processed_count} URLs and saved content to Qdrant collection 'rag_embedding'")
